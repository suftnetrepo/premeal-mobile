...
import { StyledPage, Stack, StyledText, StyledPressable, StyledCard, dialogueService } from "fluent-styles";
...
export default function AccountScreen() {
  ...
  return (
    <StyledPage flex={1} backgroundColor={COLORS.bg} showStatusBar statusBarProps={{ barStyle: "dark-content" }}>
      <StyledPage.Header backgroundColor={COLORS.bgCard} borderBottomWidth={0.5} borderBottomColor={COLORS.border}>
