...
import { StyledPage, Stack, StyledText, StyledPressable, StyledCard, dialogueService, toastService } from "fluent-styles";
  ...
  if (isLoading) {
    return (
      <StyledPage flex={1} backgroundColor={COLORS.bg} showStatusBar statusBarProps={{ barStyle: "dark-content" }}>
        <StyledPage.Header title="Order" titleAlignment="center" showBackArrow onBackPress={() => router.back()} backgroundColor={COLORS.bgCard} />
    ...
    <StyledPage flex={1} backgroundColor={COLORS.bg} showStatusBar statusBarProps={{ barStyle: "dark-content" }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        <Stack gap={14}>
          ...
          {/* Status banner */}
          <Stack backgroundColor={`${statusColor}14`} borderRadius={14} padding={14} borderLeftWidth={3} borderLeftColor={statusColor}>
